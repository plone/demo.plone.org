      ...
      <Container layout className="footer">
        <div className="footer-message">
          <FormattedMessage
            ...
            values={{
              plonecms: <FormattedMessage id="Plone{reg} Open Source CMS/WCM" defaultMessage="Plone{reg} Open Source CMS/WCM" values={{ reg: <sup>®</sup> }} />,
              copyright: <abbr title={intl.formatMessage(messages.copyright)}>©</abbr>,
